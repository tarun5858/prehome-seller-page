...
import icon from "../assets/img/Logo New 24.png";
                  ...
                  <ul>
                    ...
                    <li className="mobile-dropdown dropdown">
                      ...
                      <ul className="dropdown-menu">
                        <li>
                          <a href="https://www.prehome.in/blog">Blog</a>
                        </li>
                        <li>
                          <a href="https://www.prehome.in/contactus">FAQs</a>
                        </li>
                        <li>
                          <a href="https://prehome-latest-build.vercel.app/calculators.html">
                            Calculators
                          </a>
                        </li>
                      </ul>
                    ...
                    <li className="mobile-dropdown dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li>
                          <a href="https://www.prehome.in/contactus">
                            Contact Us
                          </a>
                        </li>
                        <li>
                          <a href="https://www.prehome.in/termsandconditions">
                            Terms & Conditions
                          </a>
                        </li>
                        <li>
                          <a href="https://www.prehome.in/privacypolicy">
                            Privacy Policy
                          </a>
                        </li>
                      </ul>
                          ...
                          <details>
                            ...
                            >
                              <li style={{ marginBottom: "10px" }}>
                                <a
                                  href="https://www.prehome.in/blog"
                              ...
                              <li style={{ marginBottom: "10px" }}>
                                <a
                                  href="https://www.prehome.in/contactus"
                                  className="text-white d-block py-1"
                                  style={{ textDecoration: "none" }}
                                >
                                  FAQs
                              ...
                              <li style={{ marginBottom: "10px" }}>
                                <a
                                  href="https://prehome-latest-build.vercel.app/calculators.html"
                                  className="text-white d-block py-1"
                                  style={{ textDecoration: "none" }}
                                >
                                  Calculators
                        ...
                        <li style={{ marginBottom: "15px" }}>
                          <details>
                            ...
                            >
                              ...
                              <li style={{ marginBottom: "10px" }}>
                                <a
                                  href="https://www.prehome.in/termsandconditions"
                                  className="text-white d-block py-1"
                                  style={{ textDecoration: "none" }}
                                >
                                  Terms & Conditions
                              ...
                              <li style={{ marginBottom: "10px" }}>
                                <a
                                  href="https://www.prehome.in/privacypolicy"
                                  className="text-white d-block py-1"
                                  style={{ textDecoration: "none" }}
                                >
                                  Privacy Policy
