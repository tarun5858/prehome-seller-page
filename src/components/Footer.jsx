          ...
          <div className="row">
            <div className="col-sm-12 col-md-4 col-xl-4">
              <div className=" pe-md-5 pe-xl-0">
                ...
                <span>Dorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, </span> <br /><br />
                <p className="prefooter-yellow">Currently in Gurugram, coming soon to rest of Delhi NCR.</p>
              </div>
            </div>
